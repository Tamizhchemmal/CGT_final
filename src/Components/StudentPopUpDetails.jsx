...
export default function StudentPopUpDetails({ user }) {
  ...
  return (
    <div className="colum" id="column">
      <div className="column1" id="studentPopUpcolumn1">
        <div className="trainer-bio1">
          <div className="profile">
            <img src={ProfileLogo} alt="profile-logo" className="prof-logo1" />
          </div>
          <div className="trainer-details">
            <div className="trainer-label" id="student-label">
              <table>
                <tbody className="studentmodal-table">
                  ...
                  <tr>
                    ...
                    <td>
                      <div className="details">: {user.STUDENT_PHONE}</div>
                    </td>
                  </tr>
                  <tr>
                    <td>
                    ...
                    <td>
                      <div className="details">: {user.STUDENT_EMAIL}</div>
                    </td>
                  </tr>
                  <tr>
                    <td>
                    ...
                    <td>
                      <div className="details">
                        ...
                        {user.referral == null
                          ? "NA"
                          : user.referral.userinfo.UI_FIRST_NAME}
                      </div>
                    </td>
                  </tr>
                  <tr>
                  ...
                  <tr>
                    ...
                    <td>
                      <div className="details">: {user.STUDENT_COLLEGE}</div>
                    </td>
                  </tr>
                  <tr>
                    <td>
                    ...
                    <td>
                      <div className="details">: {user.STUDENT_DEGREE}</div>
                    </td>
                  </tr>
                </tbody>
              </table>
      ...
      <div className="column2" id="studentPopUpcolumn1">
        <div className="trainer-bio1">
              ...
              <table>
                <tbody className="studentmodal-table2">
                  <tr>
                    ...
                    <td>
                      <div className="details">: {user.course.COURSE_NAME}</div>
                    </td>
                  </tr>
                  ...
                  <tr>
                    ...
                    <td>
                      <div className="details">: {user.STUDENT_TOTAL_FEES}</div>
                    </td>
                  </tr>
                  ...
                  <tr>
                    ...
                    <td>
                      <div className="details">: {user.STUDENT_FEES_PAID}</div>
                    </td>
                  </tr>
                  <tr>
                    <td>
